package io.github.mnyudina.util;
...
public class MySparseGraph<V, E> extends SparseGraph<V, E> {
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("Number of nodes: " + getVertexCount());
		sb.setLength(sb.length());
		sb.append("\nNumber of edges: ").append(undirected_edges.keySet().size() + directed_edges.keySet().size());
		sb.append("\nNumber of single edges: ").append(directed_edges.keySet().size());
		sb.append("\nNumber of mutual edges: ").append(undirected_edges.keySet().size());
		if(loops>0)	sb.append("\nNumber of ignored loops: ").append(loops);
		if(ignored>0) sb.append("\nNumber of parallel ignored edges: ").append(ignored);
